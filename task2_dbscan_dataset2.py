...
plt.grid(True)
plt.tight_layout()
plt.savefig("dataset2_elbow_plot.png")
plt.close()
...
print(f"Number of clusters (Dataset 2): {n_clusters}")
...
plt.ylabel("y axis")
plt.tight_layout()
plt.savefig("dataset2_clusters.png")
plt.close()
np.save("dataset2_labels.npy", labels)
np.save("dataset2_filtered.npy", filtered)
